                    ...
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-4 form-group">
                          ...
                          <select id="parent-category" name="category" class="form-control">
                            <option value="">Select Parent Category</option>
                          </select>
                        </div>

                        <div class="col-md-4 form-group">
                          <label for="category" class="form-label">Chil Category</label>
                          <select id="child-category" name="child_category" class="form-control">
                        ...
                        <div class="col-md-3 form-group">
                          ...
                          <input type="text" id="zip-code" name="zip_code" class="form-control" placeholder="Enter Zip Code" value="{{ $business->businessAddress->zip_code }}">
                        </div>

                        <div class="col-md-3 form-group">
                          <label for="inputCity" class="form-label">City</label>
                          <select id="city" name="city" class="form-control">
                            <option value="{{ $business->businessAddress->city }}">{{ $cityName ?? 'Select City' }}</option>
                          </select>
                        </div>

                        <div class="col-md-3 form-group">
                          <label for="state" class="form-label">State</label>
                          <input type="text" id="state" name="state" class="form-control" placeholder="State" readonly value="{{ $business->businessAddress->state }}">
                        </div>

                        <div class="col-md-3 form-group">
                          <label for="country" class="form-label">Country</label>
                          <input type="text" id="country" name="country" class="form-control" placeholder="Country" readonly value="{{ $business->businessAddress->country }}">
                        </div>

                        <div class="col-md-3 form-group">
                          <label for="latitude" class="form-label">Latitude</label>
                          <input type="text" id="latitude" name="latitude" class="form-control" placeholder="Latitude" readonly value="{{ $business->businessAddress->latitude }}">
                        </div>

                        <div class="col-md-3 form-group">
                          <label for="longitude" class="form-label">Longitude</label>
                          <input type="text" id="longitude" name="longitude" class="form-control" placeholder="Longitude" readonly value="{{ $business->businessAddress->longitude }}">
                        </div>
...
<!--end::Container-->
  ...
  <!-- /.content-wrapper -->
    <script>
      ...
      var selectedParent = "{{ $business->businessProfile->category_id }}";
      var selectedChild = "{{ $business->businessProfile->child_category_id }}";
